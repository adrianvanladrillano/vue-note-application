<template>
  <div>
    <div v-if="editor">
      ...
      <v-dialog v-model="dialogCommand" hide-overlay width="400">
        <v-card class="px-5 py-5">
          <v-text-field ref="shets" v-model="shet" label=""></v-text-field>
          <v-btn @click="createCommand"></v-btn>
          <v-btn
            @click="
    ...
    <div class="mt-5" @keyup="keymonitor">
